...
ALTER TABLE ACCOUNTS_ORDERS
    ADD CONSTRAINT ACCOUNT_ID_ORDER_ID_PK PRIMARY KEY (ACCOUNT_ID, ORDER_ID);
...
ALTER TABLE ORDERS_GOODS
    ADD CONSTRAINT ORDER_ID_GOOD_ID_PK PRIMARY KEY (ORDER_ID, GOOD_ID);

--changeset ChSergeiG:create_default_admin context:dml

INSERT INTO ACCOUNTS (ID, LOGIN, PASSWORD, SALTED, STATUS)
VALUES (1, 'admin', 'q', FALSE, 'ACTIVE');
