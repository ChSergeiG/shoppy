...
public class GoodsRecord extends UpdatableRecordImpl<GoodsRecord> implements Record4<Integer, String, String, Status> {
    ...
    @Override
    public GoodsRecord values(Integer value1, String value2, String value3, Status value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public GoodsRecord(Integer id, String name, String article, Status status) {
        super(Goods.GOODS);
