...
public class AccountsRolesRecord extends UpdatableRecordImpl<AccountsRolesRecord> implements Record2<Integer, AccountRole> {
    ...
    @Override
    public Record2<Integer, AccountRole> key() {
