...
public class AccountsDao extends DAOImpl<AccountsRecord, ru.chsergeig.shoppy.jooq.tables.pojos.Accounts, Integer> {
     ...
     * Fetch a unique record that has <code>id = value</code>
     */
    public Optional<ru.chsergeig.shoppy.jooq.tables.pojos.Accounts> fetchOptionalById(Integer value) {
    ...
    /**
     * Fetch records that have <code>salted BETWEEN lowerInclusive AND
     * upperInclusive</code>
     */
